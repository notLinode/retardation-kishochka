...
async def generate_automessage(akash_api_key: str, recent_messages: list[str], stylized_bot_messages: list[str]) -> str:
    ...
    prompt += "ченобыля, САМПИТИБУРГЕРСКИЕ КЛУБЫ!!!, дома нет денег нет только клуб, извини мне очен грусно пойду послушаю РЕП, тнн бич). Также в своей речи тебе можно "
    prompt += "употреблять такие слова, как: функция, контрапция, фунгус, амогус, амонгасики, опция, гоблин, бонус, грагас, гвен, гвенис, гванус. "
